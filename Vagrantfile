...
Vagrant.configure('2') do |config|
  ...
  config.vm.define :windows do |config|
    ...
    config.vm.provision :shell, path: 'windows/ps.ps1', args: ['provision-jenkins-slave.ps1', config_jenkins_fqdn, config_windows_fqdn, config_jenkins_ip, config_windows_ip]
  end
